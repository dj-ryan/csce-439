...
void sendDataToROS(){
 ...
 struct IRValues values;
  ...
  sendSignedInt32MSBAndUpdateChecksum(values.dataPoint0);
  sendSignedInt32MSBAndUpdateChecksum(values.dataPoint1);
  sendSignedInt32MSBAndUpdateChecksum(values.dataPoint2);
  sendSignedInt32MSBAndUpdateChecksum(values.dataPoint3);
