...
class gameStatsMsg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.header = null;
      this.passCompleationPercentage = null;
      this.passIncompletionPercentage = null;
      ...
      if (initObj.hasOwnProperty('passCompleationPercentage')) {
        this.passCompleationPercentage = initObj.passCompleationPercentage
      }
      else {
        this.passCompleationPercentage = 0.0;
      }
      if (initObj.hasOwnProperty('passIncompletionPercentage')) {
        this.passIncompletionPercentage = initObj.passIncompletionPercentage
      }
      else {
        this.passIncompletionPercentage = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [passCompleationPercentage]
    bufferOffset = _serializer.float32(obj.passCompleationPercentage, buffer, bufferOffset);
    // Serialize message field [passIncompletionPercentage]
    bufferOffset = _serializer.float32(obj.passIncompletionPercentage, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new gameStatsMsg(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [passCompleationPercentage]
    data.passCompleationPercentage = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [passIncompletionPercentage]
    data.passIncompletionPercentage = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new gameStatsMsg(null);
    ...
    if (msg.passCompleationPercentage !== undefined) {
      resolved.passCompleationPercentage = msg.passCompleationPercentage;
    }
    else {
      resolved.passCompleationPercentage = 0.0
    }

    if (msg.passIncompletionPercentage !== undefined) {
      resolved.passIncompletionPercentage = msg.passIncompletionPercentage;
    }
    else {
      resolved.passIncompletionPercentage = 0.0
    }
