...
(cl:ensure-generic-function 'IRsensor1-val :lambda-list '(m))
(cl:defmethod IRsensor1-val ((m <balboaLL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader balboa_core-msg:IRsensor1-val is deprecated.  Use balboa_core-msg:IRsensor1 instead.")
  (IRsensor1 m))

(cl:ensure-generic-function 'IRsensor2-val :lambda-list '(m))
(cl:defmethod IRsensor2-val ((m <balboaLL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader balboa_core-msg:IRsensor2-val is deprecated.  Use balboa_core-msg:IRsensor2 instead.")
  (IRsensor2 m))

(cl:ensure-generic-function 'IRsensor3-val :lambda-list '(m))
(cl:defmethod IRsensor3-val ((m <balboaLL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader balboa_core-msg:IRsensor3-val is deprecated.  Use balboa_core-msg:IRsensor3 instead.")
  (IRsensor3 m))

(cl:ensure-generic-function 'IRsensor4-val :lambda-list '(m))
(cl:defmethod IRsensor4-val ((m <balboaLL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader balboa_core-msg:IRsensor4-val is deprecated.  Use balboa_core-msg:IRsensor4 instead.")
  (IRsensor4 m))

(cl:ensure-generic-function 'IRsensor5-val :lambda-list '(m))
(cl:defmethod IRsensor5-val ((m <balboaLL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader balboa_core-msg:IRsensor5-val is deprecated.  Use balboa_core-msg:IRsensor5 instead.")
  (IRsensor5 m))

(cl:ensure-generic-function 'rangeSensor-val :lambda-list '(m))
(cl:defmethod rangeSensor-val ((m <balboaLL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader balboa_core-msg:rangeSensor-val is deprecated.  Use balboa_core-msg:rangeSensor instead.")
  (rangeSensor m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <balboaLL>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'IRsensor1)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'IRsensor2)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'IRsensor3)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'IRsensor4)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'IRsensor5)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'rangeSensor)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <balboaLL>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'IRsensor1) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'IRsensor2) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'IRsensor3) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'IRsensor4) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'IRsensor5) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'rangeSensor) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<balboaLL>)))
  ...
  "36b86d230f7daf8cf20eff01d9c0432f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'balboaLL)))
  "Returns md5sum for a message object of type 'balboaLL"
  "36b86d230f7daf8cf20eff01d9c0432f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<balboaLL>)))
  ...
  (cl:format cl:nil "Header header~%~%int32 arduinoMillis~%int32 batteryMillivolts~%int32 angleY~%int32 angleX~%int32 angleZ~%int32 driveLeft~%int32 driveRight~%int32 speedLeft~%int32 speedRight~%int32 distanceLeft~%int32 distanceRight~%int32 IRsensor1 ## Added by group ##~%int32 IRsensor2 ## Added by group ##~%int32 IRsensor3 ## Added by group ##~%int32 IRsensor4 ## Added by group ##~%int32 IRsensor5 ## Added by group ##~%int32 rangeSensor ## Added by group ##~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'balboaLL)))
  "Returns full string definition for message of type 'balboaLL"
  (cl:format cl:nil "Header header~%~%int32 arduinoMillis~%int32 batteryMillivolts~%int32 angleY~%int32 angleX~%int32 angleZ~%int32 driveLeft~%int32 driveRight~%int32 speedLeft~%int32 speedRight~%int32 distanceLeft~%int32 distanceRight~%int32 IRsensor1 ## Added by group ##~%int32 IRsensor2 ## Added by group ##~%int32 IRsensor3 ## Added by group ##~%int32 IRsensor4 ## Added by group ##~%int32 IRsensor5 ## Added by group ##~%int32 rangeSensor ## Added by group ##~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <balboaLL>))
  ...
  (cl:list 'balboaLL
    ...
    (cl:cons ':IRsensor1 (IRsensor1 msg))
    (cl:cons ':IRsensor2 (IRsensor2 msg))
    (cl:cons ':IRsensor3 (IRsensor3 msg))
    (cl:cons ':IRsensor4 (IRsensor4 msg))
    (cl:cons ':IRsensor5 (IRsensor5 msg))
    (cl:cons ':rangeSensor (rangeSensor msg))
))
