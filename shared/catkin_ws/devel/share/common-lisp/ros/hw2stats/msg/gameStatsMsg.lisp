...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<gameStatsMsg>)))
  ...
  (cl:format cl:nil "Header header~%~%# total passes compleated~%float32 passCompleationPercentage~%# total passes dropped~%float32 passIncompletionPercentage~%# total rushing yards~%float32 totalRushingYards~%# total passing yards~%float32 totalPassingYards~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'gameStatsMsg)))
  "Returns full string definition for message of type 'gameStatsMsg"
  (cl:format cl:nil "Header header~%~%# total passes compleated~%float32 passCompleationPercentage~%# total passes dropped~%float32 passIncompletionPercentage~%# total rushing yards~%float32 totalRushingYards~%# total passing yards~%float32 totalPassingYards~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
